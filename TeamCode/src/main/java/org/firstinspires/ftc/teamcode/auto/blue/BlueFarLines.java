...
public class BlueFarLines implements AutonomousOpMode {
    ...
    public BlueFarLines(HardwareMap hardwareMap, Telemetry telemetry) {
...
//                    currentState = AutonomousStates.DRIVE_TO_BACKDROP;
    ...
    private void initHardware() {
        ...
        startingPose = RoadRunnerLocations.BlueLocations.FAR_STARTING.getPose();
        ...
        visionController = new VisionController(hardwareMap, false, false, true, telemetry);
    ...
    private void createTrajectories() {
        ...
        spikeMark.add(
                ...
                // left spike mark
                drive.trajectorySequenceBuilder(RoadRunnerLocations.BlueLocations.FAR_STARTING.getPose())
