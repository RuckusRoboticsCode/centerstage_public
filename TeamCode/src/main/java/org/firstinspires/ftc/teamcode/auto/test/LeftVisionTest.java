...
@Disabled
@Autonomous(name="Left Vision Test")
public class LeftVisionTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        visionController2 = new VisionController(hardwareMap, false, false, false, telemetry, ftcDashboard);
