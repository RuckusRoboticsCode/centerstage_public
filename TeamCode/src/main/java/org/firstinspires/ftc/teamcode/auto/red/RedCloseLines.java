...
public class RedCloseLines implements AutonomousOpMode {
    ...
    public RedCloseLines(HardwareMap hardwareMap, Telemetry telemetry) {
        this(hardwareMap, telemetry, true, true);
    }

    public RedCloseLines(HardwareMap hardwareMap, Telemetry telemetry, boolean parkInCorner, boolean scorePixelLeft) {
...
//                    visionController.enableAprilTags();
    ...
    private void initHardware() {
        ...
        startingPose = RedLocations.CLOSE_STARTING.getPose();
        ...
        visionController = new VisionController(hardwareMap, false, true, true, telemetry);
    ...
    private void createTrajectories() {
        ...
        backdropPreLoad.add(
                ...
                drive.trajectorySequenceBuilder(spikeMark.get(2).end())
                        ...
                        .lineToLinearHeading(new Pose2d(28, -46, Math.toRadians(225)))
                        .lineToLinearHeading(
