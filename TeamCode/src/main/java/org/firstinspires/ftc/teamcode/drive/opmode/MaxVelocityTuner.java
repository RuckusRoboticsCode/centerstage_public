...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && timer.seconds() < RUNTIME) {
            ...
            double poseVelocity = poseVelo.vec().norm();

            maxVelocity = Math.max(poseVelocity, maxVelocity);

            double acceleration = ((poseVelocity - previousVelocity) / ((currentTime - previousTime))) * 1e9;
        ...
        telemetry.addData("Max Recommended Acceleration", maxAcceleration * 0.8);
